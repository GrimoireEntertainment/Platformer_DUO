...
public class PlayerController : MonoBehaviour, ICanTakeDamage
{
    ...
    void Update()
    {
        ...
        else if (playerRopeDetecter.isHoldingRope)
        {
            ...
            transform.position = playerRopeDetecter.catchKnot.transform.position + playerRopeDetecter.catchKnot.transform.up * playerRopeDetecter.offsetPlayer.y * -1;
        ...
        else if (climbingState != ClimbingState.ClimbingLedge && !isDroppingToLadder)      //stop move when climbing
        {
            ...
            if (isFallingFromWall && playerCheckWater.isInWaterZone())
    ...
    public void ActiveJetpack(bool active)
    {
        ...
        else if (isJetpackActived)
        {
            ...
            obj.GetComponent<Rigidbody>().linearVelocity = new Vector2(isFacingRight ? -1 : 1, 2);
            Destroy(obj, 2);
            lastGroundPos = transform.position.y;
        }
    }
