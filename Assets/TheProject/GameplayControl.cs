...
//     version 1.11.2
//     from Assets/TheProject/GameplayControl.inputactions
//
...
public partial class @GameplayControl: IInputActionCollection2, IDisposable
{
    ...
    ~@GameplayControl()
    {
        UnityEngine.Debug.Assert(!m_PlayerControl.enabled, "This will cause a leak and performance issues, GameplayControl.PlayerControl.Disable() has not been called.");
    }
